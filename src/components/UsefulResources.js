        ...
        <div>
            ...
            <div style={resourceStyles.mainContent}>
                ...
                <ul style={styles.list}>
                    ...
                    <li style={styles.listItem}>
                        <a href="https://www.fortinet.com/resources/cyberglossary/access-control" target="_blank" rel="noopener noreferrer">
                            Access Control - Fortinet
                        </a>
                    </li>
                    <li style={styles.listItem}>
                        <a href="https://www.todyl.com/blog/why-businesses-need-access-control" target="_blank" rel="noopener noreferrer">
                            Why Businesses Need Access Control - Zach DeMeyer
                        </a>
                    </li>
